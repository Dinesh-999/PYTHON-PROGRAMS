...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.date_label = Label(self, text=f"1 USD = {self.currency_converter.convert('USD', 'INR', 1)} INDIAN RUPEES "
                                           f"\n Date : {self.currency_converter.data['date']}", relief=tk.GROOVE,
                                borderwidth=5)
