# https://code-projects.org/student-record-system-in-tkinter-python-with-source-code/
# st_records.csv file
# student-record-system-in-tkinter-python
...
def action():
    ...
    with open("C:\\Users\\asdfg\\Projects\\starterkit/Intermediate/st_records.csv", 'a', newline='') as f:
        dict_writer = DictWriter(f,
                                 fieldnames=['UserName', 'User email address', 'User age', 'User gender', 'User type',
                                             'subscribed'])
        ...
        dict_writer.writerow(
            {'UserName': user_name, 'User email address': user_email, 'User age': user_age, 'User gender': gender_vari,
