# https://techvidvan.com/tutorials/python-calculator-program/
# gui calculator
...
iptext = StringVar()
iparea = Entry(calc, font=('large,_font', 15, 'bold'), bd=10, justify="right", insertwidth=4, textvariable=iptext).grid(
    columnspan=10)
