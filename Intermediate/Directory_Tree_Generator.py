...
# @date: Jul 11 2017
# --------------------------
# https://github.com/lnquy/dirtree/blob/master/dirtree.py
# you can use both command line and normal usage
...
def main():
    ...
    # dir_path = os.environ["PWD"]  # for linux
    # dir_path = os.environ["CWD"]  # for windows
    dir_path = "C:\\Users\\xrb\\Pasds\\start\\Begineer"  # put manually
    if args.path != "":
        dir_path = args.path
    print(dir_path)
